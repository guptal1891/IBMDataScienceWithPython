...
def build_scatter(site_dropdown,slider_range):
    ...
    payloadfiltererd_df= spacex_df[slide]

    if site_dropdown == 'ALL':
        
        title_scatter = f"Payload and Booster Versions for site: {site_dropdown}"
        fig = px.scatter(payloadfiltererd_df,x="Payload Mass (kg)", y="class", color="Booster Version Category", title=title_scatter)

    else:
        selectted_df= payloadfiltererd_df[payloadfiltererd_df['Launch Site'] == site_dropdown]
        title_scatter = f"Payload and Booster Versions for site {site_dropdown}"
        fig = px.scatter(selectted_df, x="Payload Mass (kg)", y="class", color="Booster Version Category", title=title_scatter)
